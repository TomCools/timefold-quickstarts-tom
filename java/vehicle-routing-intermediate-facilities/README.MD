# Vehicle Routing with intermediate facilities (Java, Quarkus, Maven)

Find the most efficient routes for a fleet of vehicles with limited capacity and intermediate drop-off facilities.
